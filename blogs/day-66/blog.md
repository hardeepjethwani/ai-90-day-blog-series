# AI Memory: What Should Agents Remember and What Should They Forget?

![AI Memory: What Should Agents Remember and What Should They Forget? hero](assets/hero.png)

Welcome to **Day 66 of 90 Days of AI**.

Today we are tackling **AI Memory: What Should Agents Remember and What Should They Forget?**.
...
Discuss short-term memory, long-term memory, user preferences, privacy, and retrieval.

Here is the plain-English version:

> AI Memory: What Should Agents Remember and What Should They Forget? is worth learning because it changes how people build, automate, create, decide, or work with AI systems.
...
Agentic AI is where models stop being only answer machines and start becoming workflow machines.
...
For **Agentic AI**, this matters because the winners will not be the people who use the fanciest tool once. The winners will be the people who turn the idea into a repeatable system.

## The core mental model

![AI Memory: What Should Agents Remember and What Should They Forget? concept flow](assets/concept-flow.png)

Use this four-step frame:

1. **Goal** - understand the job before asking AI to do anything.
2. **Plan** - give the model the right context or source material.
3. **Act with tools** - let AI generate, transform, search, plan, or assist.
4. **Observe** - validate before the output touches anything important.
...
```text
Mini lab:
1. Pick one workflow related to "AI Memory: What Should Agents Remember and What Should They Forget?".
...
```text
You are helping me understand and apply: AI Memory: What Should Agents Remember and What Should They Forget?
...
AI memory, agent memory, personalized AI, LLM context
...
The big idea behind **AI Memory: What Should Agents Remember and What Should They Forget?** is not hype.
...
Tomorrow: **Mixture of Experts: Why Some Models Use Specialist Sub-Brains**.
