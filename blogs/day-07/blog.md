# Temperature, Top-p, and Why Your AI Sometimes Gets Spicy

![Temperature, Top-p, and Why Your AI Sometimes Gets Spicy hero](assets/hero.png)

Welcome to **Day 7 of 90 Days of AI**.

Today we are tackling **Temperature, Top-p, and Why Your AI Sometimes Gets Spicy**.
...
Explain decoding settings using examples for coding, brainstorming, and structured JSON.

Here is the plain-English version:

> Temperature, Top-p, and Why Your AI Sometimes Gets Spicy is worth learning because it changes how people build, automate, create, decide, or work with AI systems.
...
This is one of those foundation ideas that makes every later AI topic less foggy.
...
For **AI Foundations**, this matters because the winners will not be the people who use the fanciest tool once. The winners will be the people who turn the idea into a repeatable system.

## The core mental model

![Temperature, Top-p, and Why Your AI Sometimes Gets Spicy concept flow](assets/concept-flow.png)

Use this four-step frame:

1. **Concept** - understand the job before asking AI to do anything.
2. **Example** - give the model the right context or source material.
3. **Mental model** - let AI generate, transform, search, plan, or assist.
4. **Try it** - validate before the output touches anything important.
...
```text
Mini lab:
1. Pick one workflow related to "Temperature, Top-p, and Why Your AI Sometimes Gets Spicy".
...
```text
You are helping me understand and apply: Temperature, Top-p, and Why Your AI Sometimes Gets Spicy
...
temperature, top-p, LLM settings, AI randomness
...
The big idea behind **Temperature, Top-p, and Why Your AI Sometimes Gets Spicy** is not hype.
...
Tomorrow: **Embeddings Explained: Search by Meaning, Not Just Keywords**.
