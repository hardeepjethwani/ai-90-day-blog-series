# AI Disclosure: When Should You Tell People AI Was Used?

![AI Disclosure: When Should You Tell People AI Was Used? hero](assets/hero.png)

Welcome to **Day 60 of 90 Days of AI**.

Today we are tackling **AI Disclosure: When Should You Tell People AI Was Used?**.
...
Discuss watermarking, transparency labels, synthetic media, customer trust, and platform rules.

Here is the plain-English version:

> AI Disclosure: When Should You Tell People AI Was Used? is worth learning because it changes how people build, automate, create, decide, or work with AI systems.
...
![AI Disclosure: When Should You Tell People AI Was Used? concept flow](assets/concept-flow.png)
...
```text
You are helping me understand and apply: AI Disclosure: When Should You Tell People AI Was Used?
...
AI disclosure, AI watermarking, synthetic media disclosure
...
The big idea behind **AI Disclosure: When Should You Tell People AI Was Used?** is not hype.
...
Tomorrow: **Small Language Models: Tiny Models With Big Workplace Energy**.
