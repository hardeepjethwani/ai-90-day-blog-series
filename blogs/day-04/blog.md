# Prompt Engineering Is Not Dead, It Just Got a Real Job

![Prompt Engineering Is Not Dead, It Just Got a Real Job hero](assets/hero.png)

Welcome to **Day 4 of 90 Days of AI**.

Today we are tackling **Prompt Engineering Is Not Dead, It Just Got a Real Job**.
...
> Prompt Engineering Is Not Dead, It Just Got a Real Job is worth learning because it changes how people build, automate, create, decide, or work with AI systems.
...
![Prompt Engineering Is Not Dead, It Just Got a Real Job concept flow](assets/concept-flow.png)
...
```text
You are helping me understand and apply: Prompt Engineering Is Not Dead, It Just Got a Real Job
...
prompt engineering, AI prompts, context engineering
...
The big idea behind **Prompt Engineering Is Not Dead, It Just Got a Real Job** is not hype.
...
Tomorrow: **Context Engineering: The Skill Behind Better AI Outputs**.
