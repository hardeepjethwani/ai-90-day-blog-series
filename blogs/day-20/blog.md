# AI Agents in the Browser: The New Front Door to Work

![AI Agents in the Browser: The New Front Door to Work hero](assets/hero.png)

Welcome to **Day 20 of 90 Days of AI**.

Today we are tackling **AI Agents in the Browser: The New Front Door to Work**.
...
Discuss browser-native agents, web automation, research, shopping, and productivity.

Here is the plain-English version:

> AI Agents in the Browser: The New Front Door to Work is worth learning because it changes how people build, automate, create, decide, or work with AI systems.
...
![AI Agents in the Browser: The New Front Door to Work concept flow](assets/concept-flow.png)
...
```text
Mini lab:
1. Pick one workflow related to "AI Agents in the Browser: The New Front Door to Work".
...
```text
You are helping me understand and apply: AI Agents in the Browser: The New Front Door to Work
...
AI browser, browser agents, agentic web, AI tools
...
The big idea behind **AI Agents in the Browser: The New Front Door to Work** is not hype.
...
Tomorrow: **Coding Agents: Pair Programmer, Debugger, or Chaos Button?**.
