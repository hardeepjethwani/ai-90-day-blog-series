# The AI Manager: Why Humans May Soon Manage Agents Like Teams

![The AI Manager: Why Humans May Soon Manage Agents Like Teams hero](assets/hero.png)

Welcome to **Day 76 of 90 Days of AI**.

Today we are tackling **The AI Manager: Why Humans May Soon Manage Agents Like Teams**.
...
Discuss people delegating to agents, reviewing work, setting goals, and judging tradeoffs.

Here is the plain-English version:

> The AI Manager: Why Humans May Soon Manage Agents Like Teams is worth learning because it changes how people build, automate, create, decide, or work with AI systems.
...
![The AI Manager: Why Humans May Soon Manage Agents Like Teams concept flow](assets/concept-flow.png)
...
```text
Mini lab:
1. Pick one workflow related to "The AI Manager: Why Humans May Soon Manage Agents Like Teams".
...
```text
You are helping me understand and apply: The AI Manager: Why Humans May Soon Manage Agents Like Teams
...
AI manager, future of work, AI agents, agentic AI
...
The big idea behind **The AI Manager: Why Humans May Soon Manage Agents Like Teams** is not hype.
...
Tomorrow: **AI Teammates: Helpful Coworkers or Calendar Invaders?**.
