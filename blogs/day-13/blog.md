...
![The Agent Loop: Plan, Act, Observe, Repeat hero](assets/hero.png)

Welcome to **Day 13 of 90 Days of AI**.

Today we are tackling **The Agent Loop: Plan, Act, Observe, Repeat**.
...
Break down the core control loop behind agents with a simple coding/task example.

Here is the plain-English version:

> The Agent Loop: Plan, Act, Observe, Repeat is worth learning because it changes how people build, automate, create, decide, or work with AI systems.
...
![The Agent Loop: Plan, Act, Observe, Repeat concept flow](assets/concept-flow.png)
...
```text
Mini lab:
1. Pick one workflow related to "The Agent Loop: Plan, Act, Observe, Repeat".
...
```text
You are helping me understand and apply: The Agent Loop: Plan, Act, Observe, Repeat
...
agent loop, AI planning, tool use, AI automation
...
The big idea behind **The Agent Loop: Plan, Act, Observe, Repeat** is not hype.
...
Tomorrow: **Tool-Using AI: When the Model Stops Guessing and Starts Checking**.
