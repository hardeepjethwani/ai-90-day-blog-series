# Evals: Unit Tests for AI's Squishy Brain

![Evals: Unit Tests for AI's Squishy Brain hero](assets/hero.png)

Welcome to **Day 29 of 90 Days of AI**.

Today we are tackling **Evals: Unit Tests for AI's Squishy Brain**.
...
Explain offline evals, golden datasets, human grading, regression tests, and rubrics.

Here is the plain-English version:

> Evals: Unit Tests for AI's Squishy Brain is worth learning because it changes how people build, automate, create, decide, or work with AI systems.
...
![Evals: Unit Tests for AI's Squishy Brain concept flow](assets/concept-flow.png)
...
```text
Mini lab:
1. Pick one workflow related to "Evals: Unit Tests for AI's Squishy Brain".
...
```text
You are helping me understand and apply: Evals: Unit Tests for AI's Squishy Brain
...
LLM evals, AI evaluation, model testing, AI quality
...
The big idea behind **Evals: Unit Tests for AI's Squishy Brain** is not hype.
...
Tomorrow: **AI Observability: Watching the Model Before It Starts Freelancing**.
