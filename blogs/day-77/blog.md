# AI Teammates: Helpful Coworkers or Calendar Invaders?

![AI Teammates: Helpful Coworkers or Calendar Invaders? hero](assets/hero.png)

Welcome to **Day 77 of 90 Days of AI**.

Today we are tackling **AI Teammates: Helpful Coworkers or Calendar Invaders?**.
...
Explore AI collaborators in meetings, docs, project management, and decision support.

Here is the plain-English version:

> AI Teammates: Helpful Coworkers or Calendar Invaders? is worth learning because it changes how people build, automate, create, decide, or work with AI systems.
...
![AI Teammates: Helpful Coworkers or Calendar Invaders? concept flow](assets/concept-flow.png)
...
```text
Mini lab:
1. Pick one workflow related to "AI Teammates: Helpful Coworkers or Calendar Invaders?".
...
```text
You are helping me understand and apply: AI Teammates: Helpful Coworkers or Calendar Invaders?
...
AI teammates, AI at work, collaborative AI, future of work
...
The big idea behind **AI Teammates: Helpful Coworkers or Calendar Invaders?** is not hype.
...
Tomorrow: **AI Meetings: Summaries Are Just the Beginning**.
