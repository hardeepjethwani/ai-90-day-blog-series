# Synthetic Data: Training AI With Data AI Helped Create

![Synthetic Data: Training AI With Data AI Helped Create hero](assets/hero.png)

Welcome to **Day 68 of 90 Days of AI**.

Today we are tackling **Synthetic Data: Training AI With Data AI Helped Create**.
...
Explore synthetic data for training/evals, privacy, quality, contamination, and bias.

Here is the plain-English version:

> Synthetic Data: Training AI With Data AI Helped Create is worth learning because it changes how people build, automate, create, decide, or work with AI systems.
...
![Synthetic Data: Training AI With Data AI Helped Create concept flow](assets/concept-flow.png)
...
```text
Mini lab:
1. Pick one workflow related to "Synthetic Data: Training AI With Data AI Helped Create".
...
```text
You are helping me understand and apply: Synthetic Data: Training AI With Data AI Helped Create
...
synthetic data, AI training data, model evaluation
...
The big idea behind **Synthetic Data: Training AI With Data AI Helped Create** is not hype.
...
Tomorrow: **Model Distillation: Teaching a Smaller Model the Big Model's Tricks**.
